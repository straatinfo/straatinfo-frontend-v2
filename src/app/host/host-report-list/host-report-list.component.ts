...
export class HostReportListComponent implements OnInit {
    ...
    public dataNames: string[] = [
        'generatedReportId', 'dateReported', '_mainCategoryName',
    ...
    private ReportData(data: IReportView): any {
        return {
            ...
            date: data.dateReported || '', // bug note: date not showing on report in host list
            title: data.title || '',
    ...
    onClickChatName(data) {
        this.router.navigate([`admin/reporter/${data._reporter}`]);
    }
